...
def gpt_blurb(culprit: str) -> Tuple[str, List[str]]:
    ...
    prompt = (
        f"Действуй как позитивный и Высококвалифицированный health coach со знаниями по функциональной медицине, напиши Одной строкой: «Если завтра что-то пойдёт не так, вините {culprit}!». "
