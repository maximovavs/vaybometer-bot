...
def gpt_blurb(culprit: str) -> Tuple[str, List[str]]:
    ...
    prompt = (
        f"Действуй как позитивный но при этом Высококвалифицированный health coach с чувством юмора, который очень любит люднй и хочет сделать жизнь каждого лучше пиши Одной строкой: «Если завтра что-то пойдёт не так, вините {culprit}!». "
