...
CYPRUS_EVENING_VARIANTS = {
    "LOCAL_WEATHER": [
        "день лучше планировать без жёсткого тайминга и оставить запас на смену маршрута.",
        "завтра комфортнее двигаться без спешки и не привязывать весь день к одному сценарию.",
    ],
    "HOT_UV": [
