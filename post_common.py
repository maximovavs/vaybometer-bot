...
- Генерация картинок для вечернего поста (CY_IMG_ENABLED).
"""
...
# ===== ИМПОРТЫ ДЛЯ ГЕНЕРАЦИИ КАРТИНОК =====
try:
...
try:
    ...
    build_cyprus_evening_prompt = None

try:
    from image_prompt_cy_morning import build_cyprus_morning_prompt, MorningMetrics
except Exception:
    build_cyprus_morning_prompt = None
    MorningMetrics = None
