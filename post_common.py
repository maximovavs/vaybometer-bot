...
SAFE_TIPS_FALLBACKS = {
    ...
    "плохой воздух": ["😮‍💨 Сократите нагрузки на улице.", "🪟 Проветривайте короче, фильтры в помощь.", "🏃 Тренировки — в помещении."],
...
def _as_tz(tz: Union[pendulum.Timezone, str]) -> pendulum.Timezone:
    """Превращает вход в таймзону. Терпимо переживает, если сюда по ошибке попал 'morning'/'evening'."""
